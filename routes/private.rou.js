...
const {createPost,getItems,getFilteredItems,getSearchResults,getAPost,addToWishlist,removeFromWishlist,getDetails,informUser,buyItem,approveItem,getAllUser,blockUser,deleteItem,getItemsNotApproved,getAnUser,removeItem}=require('../controllers/private.con');
...
router.delete('/removeitem/:itemId',protect,removeItem);
