...
export default function Upload() {
  ...
  const { food, cosmetics, bags, showPieces, manure, other } = state;
  // const error = [diet, physical,mental, maternity,hygienic,other].filter((v) => v).length < 1;
   const handleChange = (event) => {
    ...
    try {
      const tags=[];
      if(state.food) tags.push("63596e70961cfe4a3023c2a5");
      if(state.cosmetics) tags.push("63596e70961cfe4a3023c2a4");
      if(state.bags) tags.push("63596e70961cfe4a3023c2a6");
      if(state.showPieces) tags.push("63596e70961cfe4a3023c2a7");
      if(state.manure) tags.push("63596e70961cfe4a3023c2a8");
      if(state.other) tags.push("63596f4bc1265a044f398048");
      if(tags.length==0)tags.push("63596e70961cfe4a3023c2a5")
            ...
            >
              ...
              onChange={(e)=>setDescription(e.target.value)}
                  ...
                  <FormControl isRequired>
                    ...
                    <Checkbox m={2} colorScheme="green" checked={food} onChange={handleChange} name="food">
                      Foods
                    </Checkbox>
                    <Checkbox m={2} colorScheme="green" checked={cosmetics} onChange={handleChange} name="cosmetics">
                      Cosmetics
                    </Checkbox>
                     <Checkbox m={2} colorScheme="green" checked={bags} onChange={handleChange} name="bags">
                      Bags
                    </Checkbox>
                     <Checkbox m={2} colorScheme="green" checked={showPieces} onChange={handleChange} name="show-pieces">
                      Show pieces
                    </Checkbox>
                     <Checkbox m={2} colorScheme="green" checked={manure} onChange={handleChange} name="manure">
                      Manure
                    </Checkbox>
